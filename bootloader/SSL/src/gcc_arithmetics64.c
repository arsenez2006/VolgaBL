 ...
 */
void unsigned_division64(
    qword_t dividend, qword_t divisor, qword_t* quotient, qword_t* remainder
) {
 ...
 * @return Quotient
 */
qword_t __udivmoddi4(qword_t a, qword_t b, qword_t* c) {
  qword_t ret;
